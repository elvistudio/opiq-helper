...
- Books: 9
- Page records included: 496
- Cover/detail records excluded: 10
- Subject-boundary records excluded: 25
- Administrative records excluded: 1
- Notes: Source archive had incorrect automatic subject labels and contains an audited second-language book. This canonical index normalizes the remaining first-language records and excludes all kit 537 pages; see `docs/audits/grade-1-estonian-subject-separation.md`.
