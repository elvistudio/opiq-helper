# Grade 2 course architecture

This deterministic architecture covers the 11 canonical Grade 2 routes and
2483 route-bounded source records. It is a planning and evidence layer, not
...
272, 273, 274, 501, 286 require learner-specific opt-in and are never default route content.
...
* 8 cross-subject project modules with separate individual evidence.

The authored policy at `grade-programmes/grade-2/topic-alignment-policy.yaml` selects source topics by stable record identity rather than
array position. Outcome mappings are 0 verified, 11 partial,
0 ambiguous and 0 missing. Project-role mappings are
0 verified, 23 partial, 1 ambiguous and
0 missing; ambiguous and missing roles remain explicit clean-room bridge requirements.
