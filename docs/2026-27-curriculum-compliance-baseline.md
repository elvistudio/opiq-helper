...
This baseline pins the official legal and curriculum versions that apply when the 2026/27 school
year begins on **2026-09-01**. It supports downstream Grade 2, Grade 4, Foundation, family and
...
|---|---|---|---|
| PGS | — | [RT I, 20.06.2026, 32](https://www.riigiteataja.ee/akt/120062026032), effective 2026-09-01 | § 23 home-learning authority verified |
...
have separate full-byte identities in the registry.
...
and verification date are separate fields. A verified 2026/27 claim must resolve to a verified
primary source whose effective interval includes 2026-09-01.
...
- an official claim linked to an unknown, partial or inapplicable source.
...
boundary, class-by-class school-curriculum presentation and career-support changes. It also records
the deterministic attachment comparison: all 14 PRÕK appendix identities and all three PLRÕK
appendix identities are byte-identical across the checked expiring and future consolidated XML
versions. The home-learning monthly-control rule already entered into force in September 2025.
...
The source snapshots are dated evidence. A later legal refresh must create a new dated
record or documented supersession rather than silently rewriting the old observation.
