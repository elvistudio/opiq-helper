...
Что должно остаться после работы: Шесть карточек классифицированы, а три решения объяснены по-русски. Шесть корректно распределённых карточек и три русских обоснования.

Эстонская поддержка: Одна понятная фраза с названием состояния и опорой.
